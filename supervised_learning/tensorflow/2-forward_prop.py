...
def forward_prop(x, layer_sizes=[], activations=[]):
    ...
    Args:
        ...
        layer_sizes (list, optional): contains the nulmber of nodes in each layer of the network. Defaults to [].
        activations (list, optional): contains the activation functions for each layer of the network. Defaults to [].
    """
